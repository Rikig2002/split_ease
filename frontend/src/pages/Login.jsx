...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      toast.success("Welcome back to SplitEase");
    ...
    <div className="min-h-screen bg-slate-950 text-white font-inter px-6 py-10 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(16,185,129,0.1)]">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Welcome back. Continue managing your shared expenses.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          New here?{" "}
          <Link to="/signup" className="text-emerald-300 hover:text-emerald-200 transition-all duration-300 ease-out">
            Create an account
          </Link>
        </p>
